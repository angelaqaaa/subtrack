...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand fw-bold" href="dashboard_mvc.php">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="dashboard_mvc.php">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="dashboard_mvc.php#spaces">
                                <i class="bi bi-list me-1"></i>My Spaces
                            </a></li>
                            <li><a class="dropdown-item" href="invitations.php">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="insights.php?action=dashboard">
                                <i class="bi bi-graph-up me-1"></i>Financial Insights
                            </a></li>
                            <li><a class="dropdown-item" href="insights.php?action=education">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="subscription_history.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="generate_api_key.php">
